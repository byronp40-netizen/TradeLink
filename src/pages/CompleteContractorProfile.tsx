...
export default function CompleteContractorProfile() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
      ...
      >
        <h1 className="text-2xl font-bold">Complete Contractor Profile</h1>
        <p className="text-sm text-slate-600">
          Fill in your business details so you can receive relevant jobs.
        </p>
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-slate-500">
            Use the same trade naming style as your jobs, for example plumbing,
            electrical, carpentry, roofing.
          </p>
        </div>
